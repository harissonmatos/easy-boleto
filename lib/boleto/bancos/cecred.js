...
class Cecred {
	...
	getNossoNumeroFormatado = function (beneficiario) {
		return utils.pad(beneficiario.getNossoNumero(), 11, '0');
	};

	getNossoNumeroECodigoDocumento = function (boleto) {
		const beneficiario = boleto.getBeneficiario();
	...
	getImprimirNome = function () {
		return false;
	};

	getLocaisDePagamentoPadrao = function () {
