...
var Santander = (function () {
	var NUMERO_SANTANDER = '033',//ok
		DIGITO_SANTANDER = '7';//	ok

	function Santander() {

	}

	Santander.prototype.getTitulos = function () {//ok
		return {
	...
	Santander.prototype.exibirReciboDoPagadorCompleto = function () {//ok
		return true;
	};

	Santander.prototype.exibirCampoCip = function () {//ok
		return false;
	};

	Santander.prototype.geraCodigoDeBarrasPara = function (boleto) {//ok
	...
	Santander.prototype.getNumeroFormatado = function () {//ok
		return NUMERO_SANTANDER;
	};

	Santander.prototype.getCarteiraFormatado = function (beneficiario) {//ok
		return pad(beneficiario.getCarteira(), 2, '0');
	};

	Santander.prototype.getCarteiraTexto = function (beneficiario) {//ok
		return pad(beneficiario.getCarteira(), 2, '0');
	};

	Santander.prototype.getCodigoFormatado = function (beneficiario) {//ok
		return pad(beneficiario.getCodigoBeneficiario(), 7, '0');
	};

	Santander.prototype.getImagem = function () {//ok
		return path.join(__dirname, 'logotipos/santander.png');
	};

	Santander.prototype.getNossoNumeroFormatado = function (beneficiario) {//ok
	...
	Santander.prototype.getNome = function () {//ok
		return 'Banco Santander S.A.';
	};

	Santander.prototype.getImprimirNome = function () {//ok
		return false;
	};
